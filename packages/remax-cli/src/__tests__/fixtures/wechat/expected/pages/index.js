...
var _page = function _page() {
  ...
  return React.createElement(index$2.default, null, React.createElement(index$2.default, _rollupPluginBabelHelpers.extends({
    ...
    id: "view",
    "data-foo": "bar"
  }, props), "foo"), TextElement, React.createElement(index$H.Lifestyle, null), React.createElement(UnBindingComponent, null), React.createElement(index$7.default, null), React.createElement(index$6.default, null), React.createElement(index$2.default, null, React.createElement(index$2.default, null, React.createElement(index$7.default, null), React.createElement(index$6.default, null), React.createElement(index$e.default, null, React.createElement(index$e.default, null, "text")))));
};
